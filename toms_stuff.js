...
console.log("toms_stuff.js loaded")
console.log("enjoy my mod!")
console.log("my mod is hosted on github!")
...
elements.goon_liquid = {
    ...
    stateLow: "goon_solid",
    tempLow: "-250",
    desc: "oh no its the goon liquid",
    }

elements.goon_solid = {
    color: ["#e1e1e1" , "#b8b8b8" , "#e1e1e1"],
    behavior: behaviors.WALL,
    category: "gooning",
    desc: "made with goon juice",
}
